...
import com.aplicacion.clients.EstadisticaFeignClient;
import com.aplicacion.clients.ProyectosFeignClient;
import com.aplicacion.models.Preguntas;
import com.aplicacion.repository.PreguntasRepository;
import com.aplicacion.services.IPreguntasServices;
...
//  ****************************	PREGUNTAS	***********************************  //
	...
	public List<String> obtenerImpactoPreguntas(@RequestParam("idProyecto") Integer idProyecto,
		...
		Preguntas p = pRepository.findByIdProyectoAndNumeroPreguntaAndFormulario(idProyecto,numeroPregunta,1);
		return p.getImpacto();
	}
